      ...
      <div className="container-fluid px-4 px-md-5">
        <div className="row gy-4 align-items-start">
          ...
          <div className="col-12 col-lg-6">
            ...
            <p className="text-white-50 mb-3">Stay informed about our latest features and tools.</p>
            <form className="d-flex gap-2 mb-2" onSubmit={(e) => e.preventDefault()}>
              <input type="email" className="form-control bg-transparent text-white border-secondary w-auto" style={{ width: 260 }} placeholder="Your Email" required />
              <button className="btn btn-light px-3">Subscribe</button>
            </form>
            <small className="text-white-50 d-block">
              By subscribing, you agree to our Privacy Policy. <a href="#" className={styles.link}>By subscribing, you agree to our Privacy Policy.</a>
            </small>
            <div className="mt-4">
              <img src="http://13.234.41.119/devenv/z.apps_new/assets/images/zdotapps_white.png" alt="Z.apps" width={120} />
            </div>
          </div>
        ...
        <div className="pt-3 mt-4 border-top border-secondary d-flex flex-column flex-md-row justify-content-between align-items-center">
          <p className="small text-white-50 mb-2 mb-md-0">© {year} ZdotApps. All rights reserved.</p>
